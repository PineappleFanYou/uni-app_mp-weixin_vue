...
import videoMain from "@/pages/video/video-main/index";
import videoCategory from "@/pages/video/video-category/index";
export default {
    components: {
    uniSegmentedControl,
    videoMain,
